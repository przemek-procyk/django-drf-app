...
class PublicIngredientsApiTests(TestCase):
    """Test unauthenticated API requestes"""
...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_filter_ingredients_assigned_to_ricpes(self):
    ...
    def test_filtered_ingredienst_unique(self):
        """Test filtered ingredienst returns q unique list"""
